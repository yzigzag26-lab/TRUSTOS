...
function toggleTheme() {
    ...
    localStorage.setItem("trustos-theme", nextTheme);
    updateThemeToggle();
}
...
function updateThemeToggle() {
    ...
    if (elements.themeToggleIcon) elements.themeToggleIcon.textContent = isLight ? "☾" : "☼";
    if (elements.themeToggleLabel) elements.themeToggleLabel.textContent = isLight ? "DARK" : "LIGHT";
}
